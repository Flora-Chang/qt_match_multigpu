...
'''
file1 = "../predict/test_word_1.csv"
file2 = "../predict/test_word_2.csv"
file3 = "../predict/test_word_3.csv"
file4 = "../predict/test_word_4.csv"
file5 = "../predict/test_char_1.csv"
file6 = "../predict/test_char_2.csv"
file7 = "../predict/test_char_3.csv"
file8 = "../predict/test_char_5.csv"
file_list = [file2, file3, file4, file5, file6, file7, file8]
'''
file1 = "../output/result1.csv"
file_list = ["../output/result2.csv", "../output/result3.csv"]
...
for file in file_list:
    ...
    print('-' * 20)
    print(df_new.head(10))
df_new['score'] = df['score']/3
print('-' * 20)
print(df_new.head(10))
df_new = df_new.sort_values(by=['query_id', 'score']).reset_index(drop=True)

df_new.to_csv("../output/" + "result_all.csv", index=False)
